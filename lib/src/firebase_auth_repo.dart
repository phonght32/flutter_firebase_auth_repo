...
class FirebaseAuthRepo {
  ...
  AuthUser get user {
    ...
    return currentUser == null ? AuthUser.empty : currentUser.toUser;
  }
  ...
  Future<void> logInWithEmailAndPassword({
    ...
    try {
      ...
      if (firebaseUser != null) {
        _cache.write<AuthUser>(key: userCacheKey, value: firebaseUser.toUser);
      }
    } on firebase_auth.FirebaseAuthException catch (e) {
  ...
  Future<void> logOut() async {
    try {
      _cache.write(key: userCacheKey, value: AuthUser.empty);
      await Future.wait([
